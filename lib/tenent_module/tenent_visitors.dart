...
import 'package:flutter_application/tenent_module/tenant_visitor_out.dart';
import 'package:flutter_application/tenent_module/tn_visitor_intime.dart';



class TenentVisitorsList extends StatelessWidget {

  final List<VisitorData> details;

 const TenentVisitorsList({ Key? key,required this.details,}) : super(key: key);
                                ...
                                children:[                                                                                                          
                                  GestureDetector(
                                   onTap: () {
                                    ...
                                    Navigator.push(
                                      context, MaterialPageRoute(builder: (context) => TenantVisitorIntime(visitor: details[index])));
                                     }else{
                                   Navigator.push(
                                  context, MaterialPageRoute(builder: (context) => TenantVisitorOuttime(visitor: details[index])));
                                     }                                                                     
                               }, 
