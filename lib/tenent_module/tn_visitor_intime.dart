...
class TenantVisitorIntime extends StatefulWidget {
  VisitorData visitor;

TenantVisitorIntime({ Key? key, required this.visitor,}) : super(key: key);

  @override
  State<TenantVisitorIntime> createState() => _TenantVisitorIntimeState();
}

class _TenantVisitorIntimeState extends State<TenantVisitorIntime> {
                        ...
                        child: TextButton(                                        
                          ...
                          onPressed: (){
                           _timer!.cancel();
                             ...
                             Navigator.push(
                             context, MaterialPageRoute(builder: (context) =>  TenantVisitorOuttime(visitor: widget.visitor,))
                             );
                          }
                                       ),
                      ),
