        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: ((context) => HomePageWM())));
          },
        ),
        actions: [
          IconButton(
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                var decodeBytes =
                    base64Decode(widget.details[index].visitorImage!);
                return Padding(
                  padding:
                        ...
                        onTap: () {
                          if (widget.details[index].outTime == '--:--:--') {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => ViewVisitorProfileWM(
                                        visitor: widget.details[index])));
                          } else {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => WMVisitorOuttime(
                                        visitor: widget.details[index])));
                          }
                        },
                        child: Container(
                            ...
                            children: [
                              Stack(children: [
                                Card(
                                  ...
                                  child: CircleAvatar(
                                    radius: 28,
                                    backgroundColor:
                                        const Color.fromARGB(255, 36, 79, 122),
                                    child: ClipOval(
                                      child: Image.memory(
                                        decodeBytes,
                                        fit: BoxFit.cover,
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      widget.details[index].visitorName!,
                                    ...
                                    Text(
                                      '+91 ${widget.details[index].visitorNumber!}',
                                      style: const TextStyle(
                                          fontSize: 15,
