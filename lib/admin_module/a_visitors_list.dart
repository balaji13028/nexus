...
import 'a_visitor_intime.dart';
import 'a_visitor_out.dart';




class AdminVisitorsList extends StatelessWidget {

  final List<VisitorData> details;

 const AdminVisitorsList({ Key? key,required this.details,}) : super(key: key);
                                ...
                                children:[                                                                                                          
                                  GestureDetector(
                                   onTap: () {
                                    ...
                                    Navigator.push(
                                      context, MaterialPageRoute(builder: (context) => AdminVisitorIntime(visitor: details[index])));
                                     }else{
                                   Navigator.push(
                                  context, MaterialPageRoute(builder: (context) =>   AdminVisitorOutime (visitor: details[index])));
                                     }                                                                     
                               }, 
