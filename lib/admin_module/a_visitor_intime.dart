...
import 'package:flutter_application/admin_module/a_visitor_out.dart';
...
class AdminVisitorIntime extends StatefulWidget {
  VisitorData visitor;

AdminVisitorIntime({ Key? key, required this.visitor,}) : super(key: key);

  @override
  State<AdminVisitorIntime> createState() => _AdminVisitorIntimeState();
}

class _AdminVisitorIntimeState extends State<AdminVisitorIntime> {
                        ...
                        child: TextButton(                                        
                          ...
                          onPressed: (){
                           _timer!.cancel();
                             ...
                             Navigator.push(
                             context, MaterialPageRoute(builder: (context) =>    AdminVisitorOutime (visitor: widget.visitor,))
                             );
                          }
                                       ),
                      ),
