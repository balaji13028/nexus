...
class OwnerVisitorIntime extends StatefulWidget {
  VisitorData visitor;

  OwnerVisitorIntime({ Key? key, required this.visitor,}) : super(key: key);

  @override
  State<OwnerVisitorIntime> createState() => _OwnerVisitorIntimeState();
}

class _OwnerVisitorIntimeState extends State<OwnerVisitorIntime> {
